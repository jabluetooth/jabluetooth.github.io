/* ============================================================================
   Inline SVG icon set — replaces the Phosphor web font (whose cross-origin
   glyph CSS does not apply inside this sandboxed preview). 24x24, currentColor.
   Same <Ic name="..." /> API the sections already use.
   ============================================================================ */
const IGNITE_ICONS = {
...
function Ic({ name, weight = "", style = {}, className = "" }) {
  const def = IGNITE_ICONS[name] || IGNITE_ICONS["dot-outline"];
  // Only fill icons designed as solid shapes; ignore weight="fill" for line
  // icons (a filled magnifying-glass / check-circle becomes a solid blob).
